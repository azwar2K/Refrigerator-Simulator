...
public class Spices extends JFrame {
	...
	class spicesData{
		...
		public spicesData(String itemName, int quantity) {
	...
	public Spices() {
		...
		scrollPane.setBounds(29, 99, 376, 446);
		...
		dataHandler database = new dataHandler("spices");
		...
		btnNewButton_4.addActionListener(new updater(table, model, "spices"));
		...
		JLabel lblNewLabel_5 = new JLabel("SPICES");
