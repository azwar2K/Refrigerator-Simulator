...
public class Meats extends JFrame {
	...
	class meatsData{
		...
		public meatsData(String itemName, int quantity) {
	...
	public Meats() {
		...
		contentPane_1.setBackground(new Color(138, 43, 226));
		...
		scrollPane.setBounds(31, 99, 376, 446);
		...
		dataHandler database = new dataHandler("Meats");
		...
		btnNewButton_4.addActionListener(new updater(table, model, "Meats"));
		...
		JLabel lblNewLabel_5 = new JLabel("MEATS");
