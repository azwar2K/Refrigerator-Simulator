...
public class Fruits extends JFrame {
	...
	class fruitsData{
		...
		public fruitsData(String itemName, int quantity) {
	...
	public Fruits() {
		...
		dataHandler database = new dataHandler("Fruits");
		...
		btnNewButton_4.addActionListener(new updater(table, model, "Fruits"));
		...
		JLabel lblNewLabel_5 = new JLabel("FRUITS");
