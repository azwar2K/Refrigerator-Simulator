...
public class Seasoning extends JFrame {
	...
	class seasoningData{
		...
		public seasoningData(String itemName, int quantity) {
	...
	public Seasoning() {
		...
		scrollPane.setBounds(30, 99, 376, 446);
		...
		dataHandler database = new dataHandler("Seasoning");
		...
		btnNewButton_4.addActionListener(new updater(table, model, "Seasoning"));
		...
		JLabel lblNewLabel_5 = new JLabel("SEASONING");
